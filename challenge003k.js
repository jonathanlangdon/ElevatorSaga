// challenge 3k: turn idle block into a function: goToClosestRequest & run initially
...
function goToClosestRequest(elevator, floors) {
  ...
  if (closestFloorRequest < 999) {
    console.log(`Idle Elevator... closest request at ${closestFloorRequest}`);
...
({
  init: function (elevators, floors) {
    ...
    // Initial finding of closest request
    setTimeout(goToClosestRequest(elevator, floors), 1000);
